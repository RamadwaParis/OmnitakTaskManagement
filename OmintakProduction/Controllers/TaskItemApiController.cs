...
namespace OmintakProduction.Controllers
{
    ...
    public class TaskApiController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<Models.TaskItem>), 200)]
        public async System.Threading.Tasks.Task<IActionResult> GetAll()
        {
            return Ok(await _context.TaskItems.OrderByDescending(t => t.CreatedAt).ToListAsync());
        }
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(Models.TaskItem), 200)]
        ...
        [HttpPost]
        [ProducesResponseType(typeof(Models.TaskItem), 201)]
        [ProducesResponseType(400)]
        public async System.Threading.Tasks.Task<IActionResult> Create(Models.TaskItem task)
        {
            ...
            await CreateHistoryEntry(task.TaskItemId, task.CreatedByUserId, TaskHistoryAction.Created, null, null, "Task created");

            return CreatedAtAction(nameof(Get), new { id = task.TaskItemId }, task);
        }
        ...
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        public async System.Threading.Tasks.Task<IActionResult> Update(int id, Models.TaskItem task)
        {
            if (id != task.TaskItemId) return BadRequest();

            var existingTask = await _context.TaskItems.AsNoTracking().FirstOrDefaultAsync(t => t.TaskItemId == id);
            ...
            {
                await _context.SaveChangesAsync();
                await CreateHistoryEntry(task.TaskItemId, task.CreatedByUserId, TaskHistoryAction.Updated, null, null, "Task updated");
            }
        ...
        public async System.Threading.Tasks.Task<IActionResult> Delete(int id)
        {
            ...
            task.IsDeleted = true;
            await _context.SaveChangesAsync();
            await CreateHistoryEntry(task.TaskItemId, task.CreatedByUserId, TaskHistoryAction.Deleted, null, null, "Task deleted");
        ...
        public async System.Threading.Tasks.Task<IActionResult> UpdateStatus(int id, [FromBody] Models.TaskStatus status)
        {
            ...
            await _context.SaveChangesAsync();
            await CreateHistoryEntry(task.TaskItemId, task.CreatedByUserId, TaskHistoryAction.StatusChanged,
        ...
        public async System.Threading.Tasks.Task<IActionResult> AssignTask(int id, [FromBody] int userId)
        {
            ...
            await _context.SaveChangesAsync();
            await CreateHistoryEntry(task.TaskItemId, task.CreatedByUserId, TaskHistoryAction.AssigneeChanged,
        ...
        {
            return await _context.TaskItems.AnyAsync(e => e.TaskItemId == id);
        }
